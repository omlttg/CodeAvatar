"""
Proposed Pytest conftest.py for e2e tests.
...
# This prevents ModuleNotFoundError and ImportError on offline CI/CD or lightweight runners.
mock_modules = [
    "whisper",
    "torch",
    "torch.cuda",
...
# Now we can safely import other things since the dependencies are mocked.
...
@pytest.fixture
def api_client():
    # FastAPI TestClient to test backend endpoints
